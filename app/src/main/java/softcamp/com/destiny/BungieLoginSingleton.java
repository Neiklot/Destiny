...
public class BungieLoginSingleton {
	...
	final static String X_API_KEY = "68c569382716442ba9ee0ffcbb6bd12c";
	...
	final static String USERAGENT = "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.125 Safari/537.36";
	...
	private void printCookies() {
		...
		for (HttpCookie co : cookieManager.getCookieStore().getCookies()) {
			log("\t" + co.getName() + "\t" + co.getValue() + "\t" + co.getMaxAge());
		}
	}
